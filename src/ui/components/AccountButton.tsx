...
const ANNOUNCEMENTS: { date: string; items: string[] }[] = [
  { date: '9 / 9', items: ['修正已知問題', '優化 UI/UX'] },
  { date: '9 / 8', items: ['新增賽事回放功能'] },
  { date: '9 / 7', items: ['新增 LiveBoard 跑馬燈功能', '新增即時觀戰功能', '強化線上人數判斷，看得到的都是人', '強化中離時勝、敗場判定，你各位的戰績要變難看了'] },
  { date: '9 / 4', items: ['想辦法理解人在新手教學中，卻完全沒打算看內容的相關優化', '再次接受這世界有手機網頁版的存在，難道手機加入主畫面／安裝 不香了嗎'] },
  { date: '9 / 1', items: ['解除 LINE／FB 鎖定', '接受這世界有手機網頁版的存在', '降低第一、二關的 BOSS 難度，BOSS 表示很傷心'] },
